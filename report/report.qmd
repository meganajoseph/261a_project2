...
To pick the best model, I compared the validation mean squared prediction error of each and picked the one with the lowest which was the LASSO model. This model removed Title I eligibility and teacher salary, implying that these are not as influential in prediction.
...
The final model is chose is the LASSO regression model. The estimated intercept term is `r round(coef(best_model, s="lambda.min")[1], 3)`, but since it is not possible for all predictors to be zero, this has little meaning. The estimated slope parameter for enrollment is `r round(coef(best_model, s="lambda.min")[2], 3)` which represents the average increase in graduation rate for an additional square root of a student, holding all other predictors constant. Title I eligibility was removed in the process, resulting in an estimated parameter of 0. The estimated slope parameter for the number of suspensions is `r round(coef(best_model, s="lambda.min")[4], 3)` which represents the average decrease in graduation rate for an additional square root of a suspension instance, holding all other predictors constant. The estimated slope parameter for the proportion of students in the IB program is `r round(coef(best_model, s="lambda.min")[5], 3)` which represents the average increase in graduation rate for an additional square root of a unit increase in the proportion of students in the IB program, holding all other predictors constant. The estimated slope parameter for the proportion of students in the gifted and talented program is `r round(coef(best_model, s="lambda.min")[6], 3)` represents the average decrease in graduation rate for an additional square root of a unit increase in the proportion of students in the gifted and talented program, holding all other predictors constant. The estimated slope parameter for the proportion of students in the AP program is `r round(coef(best_model, s="lambda.min")[7], 3)` which represents the average increase in graduation rate for an additional square root of a unit increase in the proportion of students in the AP program, holding all other predictors constant. The estimated slope parameter for the proportion of students taking one or more AP exams is `r round(coef(best_model, s="lambda.min")[8], 3)` which represents the average decrease in graduation rate for an additional square root of a unit increase in the proportion of students taking one or more AP exams, holding all other predictors constant. The estimated slope parameter for the proportion of students participating in the SAT or ACT is `r round(coef(best_model, s="lambda.min")[9], 3)` which represents the average increase in graduation rate for an additional square root of a unit increase in the proportion of students participating in the SAT or ACT, holding all other predictors constant. The estimated slope parameter for the number of full time equivalent teachers is `r round(coef(best_model, s="lambda.min")[10], 3)` which represents the average decrease in graduation rate for an additional square root of a unit increase in the number of full time equivalent teachers, holding all other predictors constant. The estimated slope parameter for the number of first year teachers is `r round(coef(best_model, s="lambda.min")[11], 3)` which represents the average increase in graduation rate for an additional square root of a unit increase in the number of first year teachers, holding all other predictors constant. The estimated slope parameter for the number of instructional aids is `r round(coef(best_model, s="lambda.min")[12], 3)` which represents the average decrease in graduation rate for an additional square root of a unit increase in the number of instructional aides, holding all other predictors constant. The estimated slope parameter for the number of counselors is `r round(coef(best_model, s="lambda.min")[13], 3)` which represents the average decrease in graduation rate for an additional square root of a unit increase in the number of counselors, holding all other predictors constant. Teacher salary was also removed by the LASSO model, resulting in an estimated parameter of 0.
...
Table 1 presents the mean squared prediction error for each model created and the final model, with the base model having the highest MSPE and the LASSO model having the lowest MSPE, and the MSPE on the test set is comparable to that of the validation set for the same model.

| Base Model MSPE (Validation) | Transformed Model MSPE (Validation) | LASSO Model MSPE (Validation) | Final Model MSPE (Test) |
|------------------|------------------|------------------|------------------|
| `r round(mspe_bm, 3)` | `r round(mspe_tm, 3)` | `r round(mspe_lasso, 3)` | `r round(mspe_final, 3)` |

: This table shows the mean squared prediction errors on the validation set for each created model and for the chosen model on the testing set.
...
1 & X_1 & X_2 & X_3 & X_4 & X_5 & X_6 & X_7 & X_8 & X_9 & X_{10} & X_{11} & X_{12} & X_{13} \\ \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert & \vert
\end{bmatrix}
\begin{bmatrix} 
...
\end{bmatrix}$$ The predictors with a parameter estimate of zero, Title I eligibility and teacher salary, were removed by LASSO regularization. This model has a test mean squared prediction error of `r round(mspe_final, 3)`. This means that college readiness, staff demographics, and school demographics can predict graduation rates, but Title I eligibility and teacher salary were not influential enough to improve predictions.
...
interpret in rmse in context

can make a table and comment on the most important ones
