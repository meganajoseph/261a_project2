...
Can college readiness, student demographics, and school demographics predict graduation rates in California high schools?
...
The variables from this dataset are the number chronically absent students, the number of students enrolled in the International Baccalaureate Diploma Program, the number of students enrolled in the gifted and talented programs, the number of students enrolled in at least one AP course, the number of students that took one or more AP exams, the number of students participating in dual enrollment or dual credit programs, the number of students participating in the SAT or ACT, the number of suspensions, the number of full-time teachers, number of first-year teachers, number of full-time equivalent instructional aides or paraprofessionals, number of full-time equivalent school counselors, and teacher salary.

I picked these variables because tudents participating in higher level courses, taking college classes, and/or participating in college-preparatory exams would be most interested in graduating and going to college. Absenteeism and suspensions would make it more difficult for students to graduate. Increased support from experienced teachers and other aides can motivate students to do well in school. Higher teacher salary will motivate teachers to put more effort in helping their students.

## Model Estimates of Poverty in Schools (MEPS) {#sec-meps}

The estimated percentage of students living in poverty comes for the Model Estimates of Poverty in Schools (MEPS) dataset. The number of students eligible for free and reduced lunch has been used to determine the students from low-income households [@MEPS_report]. Since eligibility has changed over the years, it is no longer a viable metric. Model Estimates of Poverty in Schools specifically estimates the school-level share of students from household with incomes at or below the federal poverty level [@MEPS_report]. Estimates were built from school-level CCD data for the 2013-14 through 2018-29 school years and the income-to-poverty ratio from the National Center for Education Statistics Education Demographic and Geographic Estimates data [@MEPS_report]. To estimate poverty, a linear mixed effects model is used.
