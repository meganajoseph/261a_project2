...
2.  do i need to add more info for describing the dataset
3.  should i also put information on mse of training? should i put other metrics besides mspe?
4.  is my interpretation of the estimated parameters ok?
5.  is the way i wrote the final model ok
6.  not sure if what i'm concluding is right, like can i just say that i answered the rq because lasso didn't delete all of them?
7.  lines are appearing in references because of no author, how to / should i fix?
